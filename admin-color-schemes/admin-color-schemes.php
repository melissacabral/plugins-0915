...
class ACS_Color_Schemes {
	...
	private $colors = array(
		...
		'cruise', 'flat', 'lawn', 'seashore', 'awesome'
	);
	...
	function add_colors() {
		...
		wp_admin_css_color(
			'awesome', __( 'Awesome', 'admin_schemes' ),
			plugins_url( "awesome/colors$suffix.css", __FILE__ ),
			array( '#FF00D2', '#1AD71A', '#DB7927', '#1A9DE8' ),
			array( 'base' => '#EB6214', 'focus' => '#F3B211', 'current' => '#381AF0' )
		);
